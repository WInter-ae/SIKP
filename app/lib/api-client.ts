 ...
 * Menggunakan INTERNSHIP_API_BASE_URL (saat ini sama dengan API_BASE_URL — monolith)
 */
...
// Alias untuk service-service pelaksanaan magang — mengarah ke internshipClient
