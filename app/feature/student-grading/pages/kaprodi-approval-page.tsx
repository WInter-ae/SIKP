...
import { getPendingKaprodiApprovals, getGradePdfDownloadUrl } from "../services/approval-api";
import ApprovalDialog from "../components/approval-dialog";
import type { CombinedGradeWithApproval } from "../types/approval.d";

export default function KaprodiApprovalPage() {
  ...
  const fetchPendingGrades = async () => {
    setLoading(true);
    const response = await getPendingKaprodiApprovals();
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                Approval Nilai KP - Kaprodi
              </h1>
              <p className="text-gray-600">
                Daftar nilai KP yang menunggu approval final dari Kaprodi
              </p>
            </div>
          </div>
          <Card>
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Alert className="border-purple-200 bg-purple-50">
          ...
          <AlertDescription>
            <strong>Approval Kaprodi adalah tahap terakhir.</strong> Setelah Anda
            approve dengan e-signature, sistem akan otomatis generate PDF nilai
            KP final yang dapat didownload mahasiswa.
          </AlertDescription>
        </Alert>
                      ...
                      <AlertDescription>
                        <div className="flex items-center justify-between">
                          <span className="text-sm">
                            Sudah di-approve oleh Dosen Pembimbing
                          </span>
                          {grade.dosenSignedAt && (
                            <span className="text-xs text-gray-600">
                              {new Date(grade.dosenSignedAt).toLocaleDateString(
                                "id-ID",
                                {
                                  day: "numeric",
                                  month: "long",
