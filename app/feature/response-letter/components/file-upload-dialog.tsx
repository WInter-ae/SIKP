...
export function FileUploadDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Upload Ulang Surat Balasan</DialogTitle>
          <DialogDescription>
            Pilih file PDF untuk mengganti surat balasan
          </DialogDescription>
        </DialogHeader>
        ...
        >
          <input
            type="file"
            className="hidden"
            id="file-upload-dialog-response-letter"
            onChange={handleFileChange}
            accept="application/pdf"
          />
          <label
            htmlFor="file-upload-dialog-response-letter"
