...
const NOTIFICATIONS: Notification[] = [
  {
    id: "1",
    type: "warning",
    title: "Periode Magang Selesai - Perlu Penilaian",
    message: "Periode magang Ahmad Fauzi telah selesai. Mohon segera berikan penilaian akhir.",
    timestamp: "1 jam yang lalu",
    isRead: false,
    link: "/mentor/penilaian",
  },
  {
    id: "2",
    type: "info",
    title: "Mahasiswa Magang Baru",
    message: "Dewi Kartika telah ditambahkan sebagai mahasiswa magang Anda",
