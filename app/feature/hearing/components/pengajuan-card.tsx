      ...
      <Card className="shadow-md hover:shadow-lg transition-shadow border-2">
        <CardHeader className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950 dark:to-cyan-950">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-3 flex-1">
              <Avatar className="h-12 w-12 bg-green-600 text-white flex items-center justify-center font-semibold">
        ...
        <CardContent className="pt-6 space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="grid gap-3 bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">
              <div className="flex items-start gap-3">
                <MapPin className="h-5 w-5 text-gray-500 mt-0.5 flex-shrink-0" />
                <div className="flex-1">
                  <p className="text-sm text-gray-600 dark:text-gray-400">Tempat</p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <Button
              ...
              className="flex-1 bg-green-700 hover:bg-green-800 h-11 font-semibold gap-2"
            >
