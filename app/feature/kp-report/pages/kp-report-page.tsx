    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-6 space-y-6 sm:space-y-8">
      ...
      <Alert className="border-l-4 border-primary bg-primary/5">
        ...
        <AlertDescription className="text-sm sm:text-base text-foreground">
          Lengkapi semua tahapan secara berurutan: Pengajuan Judul → Dosen
          Pembimbing → Upload Laporan
        </AlertDescription>
      </Alert>
      ...
      >
        <TabsList className="grid w-full grid-cols-4 h-auto p-1">
          <TabsTrigger
            value="judul"
            className="flex items-center justify-center gap-1 sm:gap-2 px-2 py-2 sm:py-2.5 text-xs sm:text-sm"
          >
              ...
              <CardContent className="pt-6">
                <Alert className="border-l-4 border-yellow-500 bg-yellow-50">
                  ...
                  <AlertDescription className="text-yellow-800">
                    Anda hanya dapat mengajukan perubahan judul setelah judul
                    awal disetujui
                  </AlertDescription>
                </Alert>
              </CardContent>
            ...
            <CardContent>
              <div className="space-y-3 text-sm">
                <div className="flex gap-2">
                  ...
                  <p>
                    Pastikan judul laporan sudah disetujui oleh dosen pembimbing
                  </p>
                </div>
                <div className="flex gap-2">
                  <span className="font-medium min-w-[30px]">2.</span>
                  <p>
                    Format laporan harus sesuai dengan template yang telah
                    ditentukan
                  </p>
                </div>
                <div className="flex gap-2">
                ...
                <div className="flex gap-2">
                  ...
                  <p>
                    Pastikan semua komponen laporan lengkap (cover, abstrak, bab
                    1-5, daftar pustaka, lampiran)
                  </p>
                </div>
                <div className="flex gap-2">
                  <span className="font-medium min-w-[30px]">5.</span>
                  <p>
                    Laporan yang sudah diupload akan direview oleh dosen
                    pembimbing
                  </p>
                </div>
                  ...
                  <AlertDescription className="text-blue-800">
                    ...
                    <a
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        alert(
                          "Download template (implementasi backend diperlukan)",
                        );
                      }}
                    >
          ...
          <div className="space-y-3">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
              ...
              <span className="text-sm sm:text-base font-medium capitalize">
                ...
                {reportData.statusJudul === "diajukan" &&
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
              ...
              <span className="text-sm sm:text-base font-medium">
                {currentLecturer?.nama || "Belum ditetapkan"}
              </span>
            </div>
            <Separator />
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 sm:gap-0">
