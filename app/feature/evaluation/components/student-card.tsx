  ...
  return (
    ...
    >
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-3 flex-1">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-semibold text-lg text-gray-900 group-hover:text-green-700:text-green-400 transition-colors truncate">
                {student.name}
              </h3>
      ...
      <CardContent className="space-y-3">
        ...
        {/* Grade Summary */}
        <div className="grid grid-cols-2 gap-3 pt-2 border-t">
          <div className="text-center p-2.5 bg-blue-50 rounded-md space-y-1">
            <Badge
              variant="outline"
          ...
          <div className="text-center p-2.5 bg-purple-50 rounded-md space-y-1">
            <Badge
              variant="outline"
        ...
        <div className="pt-2 border-t">
          <div className="flex items-center justify-center gap-2 text-sm text-green-700 group-hover:text-green-800:text-green-300 font-medium">
