...
export function RevisiUploadForm({
  revisi,
  onUpload,
  onCancel,
}: RevisiUploadFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3 p-4 bg-muted rounded-lg">
            ...
            <div>
              ...
              <span
                className={`inline-flex px-2 py-1 rounded text-xs font-medium border ${getPrioritasColor(revisi.prioritas)}`}
              >
