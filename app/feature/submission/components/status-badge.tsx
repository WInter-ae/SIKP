...
export function StatusBadge({ status, size = "md" }: StatusBadgeProps) {
  ...
  switch (status) {
    case "APPROVED":
      return (
        <Badge
          className={`${baseClass[size]} bg-green-500 text-white hover:bg-green-600 flex items-center w-fit`}
        >
    ...
    case "REJECTED":
      return (
        <Badge
          className={`${baseClass[size]} bg-red-500 text-white hover:bg-red-600 flex items-center w-fit`}
        >
    ...
    case "PENDING":
      return (
        <Badge
          variant="outline"
          className={`${baseClass[size]} flex items-center w-fit`}
        >
