...
const ORGANIZATION_DATA: OrganizationDetail = {
  ...
  description:
    "PT. Cinta Sejati adalah perusahaan teknologi yang bergerak di bidang pengembangan perangkat lunak dan solusi digital. Dengan pengalaman lebih dari 10 tahun, kami telah membantu berbagai perusahaan dalam transformasi digital mereka. Kami menyediakan lingkungan kerja yang kondusif bagi mahasiswa untuk belajar dan berkembang.",
  category: "Teknologi",
  studentCount: 10,
  partnerSince: 2023,
  rating: 4.8,
...
function DetailReferensi() {
  ...
  const gradientColor =
    CATEGORY_COLORS[ORGANIZATION_DATA.category] || "from-gray-500 to-gray-600";
                  ...
                  <CardContent className="space-y-8">
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {ORGANIZATION_DATA.highlights.map(
                          (highlight, index) => (
                            <div
                              key={index}
