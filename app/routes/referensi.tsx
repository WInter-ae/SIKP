...
function ReferensiCard({ item, isDarkMode, index }: ReferensiCardProps) {
  const gradientColor =
    CATEGORY_COLORS[item.category || ""] || "from-gray-500 to-gray-600";
...
function Referensi() {
  ...
  const totalStudents = REFERENSI_DATA.reduce(
    (acc, item) => acc + (item.studentCount || 0),
    0,
  );
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            >
              Temukan tempat Kerja Praktik yang sesuai dengan minat dan bidang
              kamu
            </p>
          </div>
