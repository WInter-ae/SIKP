        ...
        <div className="container mx-auto px-4 relative z-10">
                ...
                <CardContent className="p-6 sm:p-10 md:p-16">
                  <div className="flex flex-col lg:flex-row items-center gap-6 sm:gap-10">
                    ...
                    <div className="flex-1 text-center lg:text-left">
                      ...
                      >
                        Portal Kerja Praktik adalah aplikasi yang dirancang
                        untuk mempermudah mahasiswa dalam mencari, mendaftar,
                        dan melaksanakan program kerja praktik. Dengan sistem
                        yang terintegrasi, proses administrasi menjadi lebih
          ...
          <div>
            <div className="text-center mb-10 sm:mb-16">
              ...
              >
                Tim yang berdedikasi untuk mengembangkan platform terbaik bagi
                mahasiswa
              </p>
            </div>
