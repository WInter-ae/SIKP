      ...
      <section className="relative min-h-[calc(100vh-64px)] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white px-4 sm:px-6 py-8 max-w-5xl w-full">
          ...
          <p className="text-base sm:text-xl md:text-2xl mb-8 sm:mb-12 leading-relaxed text-white/80 max-w-3xl mx-auto font-light">
            ...
            dirancang untuk mempermudah mahasiswa dalam mencari, mendaftar, dan
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-10 sm:mb-16">
            ...
            >
              Pastikan kamu memenuhi semua persyaratan sebelum mendaftar Kerja
              Praktik
            </p>
          </div>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-10 sm:mb-16">
            ...
            >
              Ikuti langkah-langkah berikut untuk menyelesaikan program Kerja
              Praktik
            </p>
          </div>
