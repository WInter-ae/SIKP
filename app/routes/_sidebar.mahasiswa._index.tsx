      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        ...
        <Card className="col-span-3">
          <CardHeader>
            ...
            <CardDescription>Detail tim magang Anda</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              {
                action: "Mengirim Laporan Mingguan #4",
                time: "2 jam yang lalu",
                status: "success",
              },
              {
                action: "Mengupdate Logbook Harian",
                time: "5 jam yang lalu",
                status: "success",
              },
              {
                action: "Surat Balasan Diterima",
                time: "1 hari yang lalu",
                status: "info",
              },
              {
                action: "Pengajuan Magang Disetujui",
